...
//         const errorMessage =
//           response.data.data || response.data.message || "Failed to send offer";
...
// export const getOffersByRequestId = createAsyncThunk(
//   "serviceOffer/getByRequestId",
//   async (requestId: string, { rejectWithValue, dispatch }) => {
//     try {
//       const response = await getAxiosInstance().get(
//         `/serviceOffer/request/${requestId}`
//       );
...
//   "serviceOffer/accept",
//   async (
//     data: { offerId: string; customerId: string },
//     { rejectWithValue, dispatch }
//   ) => {
//     try {
//       const response = await getAxiosInstance().put(
//         `/serviceOffer/${data.offerId}/accept`,
//         data.customerId
//       );
...
//     try {
//       const response = await getAxiosInstance().put(
//         `/serviceOffer/${data.offerId}/reject`,
//         data.customerId
//       );
...
//   "serviceOffer/getByProviderId",
//   async (providerId: string, { rejectWithValue, dispatch }) => {
//     try {
//       const response = await getAxiosInstance().get(
//         `/serviceOffer/provider/${providerId}`
//       );
...
//       const requestIds = response.data.data.map(
//         (offer: ServiceOffer) => offer.serviceRequestId
//       );
...
//   "serviceOffer/getById",
//   async (offerId: string, { rejectWithValue, dispatch }) => {
//     try {
//       // First get the offer
//       const response = await getAxiosInstance().get(
//         `serviceOffer/offer/${offerId}`
//       );
...
//         if (
//           state.currentOffer &&
//           state.currentOffer.id === action.meta.arg.offerId
//         ) {
    ...
    handleOfferAcceptedFromSignalR: (
      ...
      if (action.payload.serviceRequestId) {
        state.offers.forEach((offer) => {
          if (
            offer.serviceRequestId === action.payload.serviceRequestId &&
