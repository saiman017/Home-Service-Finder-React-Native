...
//             /> */}
//             <Text style={styles.providerName}>{offerDetails?.providerName || "Provider"}</Text>
//             <Text style={styles.contactNumber}>Contact: {offerDetails?.providerName || "N/A"}</Text>
//           </View>
...
//                   <Image key={imageUri} source={{ uri: `http://10.0.2.2:5039${imageUri}` }} style={styles.problemImage} resizeMode="cover" />
//                 ))}
//               </ScrollView>
//             ) : (
